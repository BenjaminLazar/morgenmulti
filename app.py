...
# Text input
user_text = st.text_input("Skriv tanker eller overvejelser omkring talen her:")


# Image input
uploaded_file = st.file_uploader("Vælg billede", type=["jpg", "jpeg", "png"])
...
if st.button('Send to ChatGPT Vision'):
